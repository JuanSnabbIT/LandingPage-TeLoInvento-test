...
/**
 * Scene v2 end-to-end (spec 13 §10). These assert the *contract* of the scene,
...
/**
 * Waits for the v2 canvas to have reported ready (it is what adds `scene-v2`
 * and installs `window.__scene`) and for the layout it changes to settle:
 * `.scene-v2` reveals `.capacidades__stage`, which moves every section below
