...
export const curlGlsl = /* glsl */ `
  ...
  vec3 curl(vec3 p) {
    const float e = 0.1;
    float n1, n2;
    n1 = snoise(p + vec3(0., e, 0.)); n2 = snoise(p - vec3(0., e, 0.)); float a = (n1 - n2) / (2. * e);
    n1 = snoise(p + vec3(0., 0., e)); n2 = snoise(p - vec3(0., 0., e)); float b = (n1 - n2) / (2. * e);
    n1 = snoise(p + vec3(e, 0., 0.)); n2 = snoise(p - vec3(e, 0., 0.)); float c = (n1 - n2) / (2. * e);
